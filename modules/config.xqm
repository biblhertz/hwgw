...
(:~
 ...
 :)
declare variable $config:webcomponents := "local"; (: keep 2.24.1 as 2.24.2 breaks TOC layout :)
...
(:
 ...
 :)
declare variable $config:default-template :="woelfflin-base.html";
...
(:
 ...
 :)
declare variable $config:pagination-fill := 6;
...
declare variable $config:facets := [
    ...
    map {
        ...
        "output": function($label) {
            config:volume-title($label)
        }
    },
    map {
        "dimension": "context",
        "heading": "hwgw.context",
        "hierarchical": true()
    },
    map {
        "dimension": "type",
...
declare variable $config:context-path :=
    if (equals(request:get-header("X-Forwarded-Host"), "hwgw.humanitiesconnect.pub"))
        then ""
    else if (equals(request:get-header("Host"), "hwgw.humanitiesconnect.pub"))
        then ""
    else
...
(:~
 ...
 :)
declare variable $config:default-odd :="woelfflin-books.odd";
...
declare variable $config:odd-available :=(
    "woelfflin-base.odd", 
    "woelfflin-books.odd", 
    "woelfflin-apparatus.odd", 
    "woelfflin-introduction.odd", 
    "woelfflin-books-comments.odd", 
    "woelfflin-apparatus-comments.odd", 
    "woelfflin-introduction-comments.odd", 
    "woelfflin-index.odd", 
    "woelfflin-meta.odd", 
    "woelfflin-index-entry-list.odd",
    "annotations.odd");
